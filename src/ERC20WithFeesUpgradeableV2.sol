...
abstract contract ERC20WithFeesUpgradeableV2 is
	ERC20Upgradeable,
	...
	IERC20WithFeesUpgradeableErrors
{
	...
	function __ERC20WithFees_init_unchained(
		...
		$._feeExempt[feeCollectionAddress_] = true;
		$._feeExempt[minter_] = true;
	}
	...
	function reduceFeeRate(uint256 newFeeRate) public onlyOwner {
		ERC20WithFeesStorage storage $ = _getERC20WithFeesStorage();
		require(newFeeRate <= $.feeRate, "New fee must be lower than current fee");
